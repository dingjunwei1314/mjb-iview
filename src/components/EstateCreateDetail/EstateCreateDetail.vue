    ...
    <Row style="border:1px solid #ccc;padding:20px">
      ...
      <Form style="padding-left:20px" :label-width="150">
        ...
        <FormItem prop="user" label="楼幢数量：">
          <Input v-model="form.gman" placeholder="" :number="true" style="width: 100px" v-if="type === 'edit'"></Input>
          <p v-else>
        ...
        <FormItem prop="user" label="备注信息：">
          <Input v-model="form.gman" placeholder="" type="textarea" :autosize="true" style="width:50%" v-if="type === 'edit'"></Input>
          <p v-else>
